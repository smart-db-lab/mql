    ...
    <div className="min-h-[90vh] flex items-center justify-center px-4">
      <div className="w-full max-w-3xl bg-white dark:bg-gray-800 p-10 rounded-2xl shadow-lg text-center font-secondary">
        ...
        <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8">
          DL4ML is an open educational platform that makes AI concepts accessible to all. Whether you're a curious student, a data enthusiast, or a professional, we provide the guidance and tools to accelerate your journey into Machine Learning and Deep Learning.
        </p>
